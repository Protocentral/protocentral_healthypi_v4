...
# Auto-start HealthyPi on boot
    ...
    sed -i -e "\/opt\/healthypi_gui\/healthypi4_gui/d" /etc/xdg/lxsession/LXDE-pi/autostart
		echo '@/opt/healthypi_gui/healthypi4_gui &' >> /etc/xdg/lxsession/LXDE-pi/autostart
